...
Subclasses mus implement the following methods:
...
Client usage:
    ...
    3. For each image in a batches of images:
...
class InferenceWrapperBase(object):
    ...
    def build_model(self, model_config):
        ...
        :param model_config: Object containing configuration for building the model.
    ...
    def _create_restore_fn(self, checkpoint_path, saver):
        ...
        :param checkpoint_path: Checkpoint file or a directory containing a checkpoinrt
            file.
        ...
        if tf.gfile.IsDirectory(checkpoint_path):
            ...
            if not checkpoint_path:
                raise ValueError("No checkpoint file fount in: %s" % checkpoint_path)
    ...
    def build_graph_from_proto(self, graph_def_file, saver_def_file,
        ...
        :param graph_def_file: File containing serialized GraphDef proto.
        :param saver_def_file: File containing a serialized SaverDef proto.
        :param checkpoint_path: Checkpoint file or a directory containing a checkpoint
            file.
        :return:
            restore_fn: A function such that restore_fn(sess) loads model variables
    ...
    def feed_image(self, sess, encoded_image):
        ...
        :param encoded_image: An encoded image string.
    ...
    def inference_step(self, sess, input_feed, state_feed):
        ...
        :param sess: TensorFlow Session object.
        :param input_feed: A numpy array of shape [batch_size].
        :param state_feed: A numpy array of shape [batch_size, state_size].
