...
class Caption(object):
    ...
    def __init__(self, sentence, state, logprob, score, metadata=None):
        ...
        :param sentence: List of word ids in the caption.
        :param state: Model state after generating the previous word.
        :param logprob: Log-probability of the caption.
        :param score: Score of the caption.
        :param metadata: Optional metadata associated with the partial sentence. If not
    ...
    #Also for Python3 compatibility.
...
class CaptionGenerator(object):
    ...
    def __init__(self,
        ...
        :param model: Object encapsulating a trained image-to-text model. Must have
