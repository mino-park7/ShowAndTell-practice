    ...
    def build_inputs(self):
        if self.mode == "inference":
            ...
            self.images = tf.random_uniform(
                [self.config.batch_size, self.config.image_height,
...
class ShowAndTellModelTest(tf.test.TestCase):
    ...
    def setUp(self):
        ...
        self._model_config = configuraion.ModelConfig()
    ...
    def _checkModelParameters(self):
        ...
        expected_param_counts = {
            ...
            # inception_output_size * embedding size
    ...
    def _checkOutputs(self, expected_shapes, feed_dict=None):
        ...
        :param expected_shapes: A dict mapping Tensor or Tensor name to expected output
        :param feed_dict: Values of Tensors to feed into Session.run().
        :return:
        """
    ...
    def testBuildForTraining(self):
        ...
        expected_shapes = {
            ...
            # [batch_size * sequence_length]
            model.target_cross_entropy_losses_weights: (480,),
        }
